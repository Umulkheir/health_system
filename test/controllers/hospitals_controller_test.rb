...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { approved: @hospital.approved, description: @hospital.description, location: @hospital.location, name: @hospital.name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { approved: @hospital.approved, description: @hospital.description, location: @hospital.location, name: @hospital.name } }
